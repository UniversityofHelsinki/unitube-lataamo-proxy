...
const PRESENTER_FLAVOR_FOR_VIDEO_THUMBNAIL = 'presenter/player+preview';

const PRESENTATION_FLAVOR_FOR_VIDEO_THUMBNAIL = 'presentation/player+preview';

const GITLAB_PATH = '/api/v4/projects/3766/releases';
...
module.exports = {
    ...
    PRESENTER_FLAVOR_FOR_VIDEO_THUMBNAIL,
    PRESENTATION_FLAVOR_FOR_VIDEO_THUMBNAIL,
    GITLAB_PATH
};
